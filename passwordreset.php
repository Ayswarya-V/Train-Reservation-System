				...
				<div class="w3layouts_main_gridl">
					<form action="passwordreset1.php" method="post" class="w3_form_post">
							...
							<span class="agileits_gridl">
								...
								<input type="text" name="t1" placeholder="Old Password" required="">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_gridl">
							...
							<input type="password" name="t2" placeholder="New Password" required="">
							</span>
						</div>
                       ...
                       <div class="w3_agileits_main_grid w3l_main_gridl">
							...
							<input type="password" name="t3" placeholder="Retype password" required="">
							</span>
						</div>
