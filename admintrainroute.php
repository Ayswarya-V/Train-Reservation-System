    ...
    <div class="center-containerl">
		<div class="mainl1">
				...
				<div class="w3layouts_main_gridl">
					<form name="form1" action="admintrainroute1.php" method="post">
<h1 align="center"> Route Addition </h1>


<div>
<br />
   <center>Enter The Route Information </center>
      ...
      <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								...
								<input type="text" name="txtst"  required="">
							</span>
						</div>
      <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label> Ending Station</label>
								<input type="text" name="txtend"  required="">
							</span>
						</div>
  <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label>Total Distance</label>
								<input type="text" name="txtdis"  required="">
							</span>
						</div>
