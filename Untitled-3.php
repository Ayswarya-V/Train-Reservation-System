...
<body >
		...
		<nav class="navbar navbar-default">
			...
			<!-- Collect the nav links, forms, and other content for toggling -->
				...
				<nav class="link-effect-2" id="link-effect-2">
					...
					<li class="active"><a href="adminnewtrain.html"><span data-hover="New Train">New Train</span></a></li>
                        
						<li  ><a href="Services.html"><span data-hover="Train Route">Train Route</span></a></li>
 ...
 <?php
    ...
    <div class="center-containerl">
		<div class="mainl1">
			<h1 class="w3layouts_headl"><font size="5"> New Train Details Addition</font></h1>
...
$s=mysqli_query($con,"select s_station_name from tbl_route_main");
while($row=mysqli_fetch_array($s))
		{
			...
			?>
                        ...
                        <?php
		$s=mysqli_query($con,"select * from tbl_route_main where route_id='$s1'"); 
		while($row=mysqli_fetch_array($s))
		{
		
		$d_station_name=$row[2];
		$totalkm=$row[3];
		...
		?>
						...
						<input name="t2" type="text" id="t2"value="<?php echo $d_station_name;?>"disabled>
							</span>
						</div>
  <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label>Distance </label>
						<input name="t3" type="text" id="t3"value="<?php echo $totalkm;?>"disabled>
							</span>
						</div>
