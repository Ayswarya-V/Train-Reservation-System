        ...
        <form name="form1" method="POST">  
			...
			<div class="col-md-4">
				     	...
				     	<input type="text" name="age[s1][<?php echo $n ?>]"  maxlength="2" /> 
							...
							<span class="agileits_gridl">
								<label>SEX</label>
				     	<input type="text" name="sex[s1][<?php echo $n ?>]"  maxlength="10" /> 
			...
			<div class="col-md-4">
				     	...
				     	<input type="text" name="age[s2][<?php echo $n ?>]"  maxlength="2" /> 
							...
							<span class="agileits_gridl">
								<label>SEX</label>
				     	<input type="text" name="sex[s2][<?php echo $n ?>]"  maxlength="10" /> 
			...
			<div class="col-md-4">
				     	...
				     	<input type="text" name="age[s3][<?php echo $n ?>]"  maxlength="2" /> 
							...
							<span class="agileits_gridl">
								<label>SEX</label>
				     	<input type="text" name="sex[s3][<?php echo $n ?>]"  maxlength="10" /> 
			...
			<div class="col-md-4">
				     	...
				     	<input type="text" name="age[s4][<?php echo $n ?>]"  maxlength="2" /> 
							...
							<span class="agileits_gridl">
								<label>SEX</label>
				     	<input type="text" name="sex[s4][<?php echo $n ?>]"  maxlength="10" /> 
				...
				<?php } }?>	
                <input type="submit" name="sublit" value="submit">
						</div>
             </form>
