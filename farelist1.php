    ...
    <div class="center-containerl">
		<div class="mainl1">
				...
				<div class="w3layouts_main_gridl">
					<form name="form1" action="farelist1.php" method="post">
<h1 align="center">Fare List </h1>
 ...
 <?php
		...
		?>
							...
							<span class="agileits_gridl">
								<center><label>Select Train Type </label>
								<select name="c1" id="c1'" disabled>
                                    
<?php
include("connection.php");
$sel="select type  from tbl_fare";
						...
						$areaOptions = "";
							...
							$areaOptions .= '<option value="' . $row['type'] . '">' . $row['type'] . '</option>';
                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
						  ...
						  <table id="example2" class="table table-bordered table-hover">
						    <thead>
							<tr><th>Sleeper Class</th><th>AC First class</th><th>AC 2 TIER</th><th>AC 3 TIER</th></tr>
							</thead>
							  <?php
                           include("connection.php");
							...
							$sel="SELECT  `s1`,`a1`,`a2`,`a3` FROM `tbl_fare` WHERE `type` = '$type'";
							...
							while($row=$res->fetch_assoc()){
									...
									echo "<tr><td>" .$row["s1"]. "</td><td>" .$row["a1"]. "</td><td>" .$row["a2"]. "</td><td>" .$row["a3"]. "</td></tr>";
