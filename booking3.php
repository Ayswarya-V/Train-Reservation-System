...
<body>
 ...
 <div class="about-breadcrumb">
    ...
    <?PHP $tid=$_GET['X']; ?>
        ...
        <form name="form1" method="POST" action="bookvkv.php">  
            ...
            <div class="w3_agileits_main_grid w3l_main_gridl">
				     	...
				     	<input type="text" name="d" readonly="readonly" id="datepicker" title="YYYY/MM/DD"  /> 
            ...
            <DIV class="w3_agileits_main_grid w3l_main_gridl">
    	<span class="agileits_gridl">
            <label> no of Sleeper</label>  <input type="text" name="t1" value="0">
         </span></DIV>
    <DIV class="w3_agileits_main_grid w3l_main_gridl">
    	<span class="agileits_gridl">  <label> no of AC 1 TIER</label>  <input type="text" name="t2" value="0"></span></DIV>
        <DIV class="w3_agileits_main_grid w3l_main_gridl"><span class="agileits_gridl">   <label> no of AC 2 TIER</label>  <input type="text" name="t3" value="0"></span></DIV>
                 <DIV class="w3_agileits_main_grid w3l_main_gridl"><span class="agileits_gridl">    <label> no of AC 3 TIER</label>  <input type="text" name="t4" value="0"></span></DIV>
