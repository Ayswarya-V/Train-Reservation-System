...
<body >
   ...
   <div class="about-breadcrumb">
    ...
    <div class="center-containerl">
		<div class="mainl1">
			<h1 class="w3layouts_headl"><font size="5"> ADD STATION</font></h1>
				<div class="w3layouts_main_gridl">
					<form action="adminstation1.php" method="post" class="w3_form_post">
					...
					<input name="stationname" type="text" id="t1" placeholder="station name">
							</span>
						</div>
					...
					<input name="stationcode" type="text"  placeholder="station name">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label> ADDRESS</label>
					<input name="adrs" type="text" id="t2" placeholder="station adress">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label> CITY</label>
					<input name="city" type="text" id="t3" placeholder="city">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label>PINCODE</label>
					<input name="pincode" type="text" id="t4" placeholder="pin code">
							</span>
						</div>
                        ...
                        <div class="w3_agileits_main_grid w3l_main_gridl">
							<span class="agileits_gridl">
								<label>CONTACT NOn</label>
					<input name="contact" type="text" id="t5" placeholder="Contact no">
							</span>
						</div>
